...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../libs/MeeusJs-master/meuusjs.1.0.3.min.js":[function(require,module,exports) {
/*
...
A.Moon = {
  ...
  geocentricPosition: function geocentricPosition(a) {
    ...
    for (var d = A.Math.pMod(A.Math.horner(c, [297.8501921 * b, 445267.1114034 * b, -.0018819 * b, b / 545868, -b / 113065E3]), 2 * Math.PI), e = A.Math.pMod(A.Math.horner(c, [357.5291092 * b, 35999.0502909 * b, -1.535E-4 * b, b / 2449E4]), 2 * Math.PI), f = A.Math.pMod(A.Math.horner(c, [134.9633964 * b, 477198.8675055 * b, .0087414 * b, b / 69699, -b / 14712E3]), 2 * Math.PI), g = A.Math.pMod(A.Math.horner(c, [93.272095 * b, 483202.0175233 * b, -.0036539 * b, -b / 3526E3, b / 86331E4]), 2 * Math.PI), k = 119.75 * b + 131.849 * b * c, m = 53.09 * b + 479264.29 * b * c, h = 313.45 * b + 481266.484 * b * c, c = A.Math.horner(c, [1, -.002516, -7.4E-6]), p = c * c, m = 3958 * Math.sin(k) + 1962 * Math.sin(a - g) + 318 * Math.sin(m), n = 0, k = -2235 * Math.sin(a) + 382 * Math.sin(h) + 175 * Math.sin(k - g) + 175 * Math.sin(k + g) + 127 * Math.sin(a - f) - 115 * Math.sin(a + f), l, h = 0; h < A.Moon.ta.length; h++) {
      l = A.Moon.ta[h];
    ...
    for (h = 0; h < A.Moon.tb.length; h++) {
      switch (l = A.Moon.tb[h], q = Math.sin(d * l[0] + e * l[1] + f * l[2] + g * l[3]), l[1]) {
        case 0:
          k += l[4] * q;
          break;
...
A.Nutation = {
  nutation: function nutation(a) {
    ...
    for (var b = A.Math.horner(a, [297.85036, 445267.11148, -.0019142, 1 / 189474]) * Math.PI / 180, c = A.Math.horner(a, [357.52772, 35999.05034, -1.603E-4, -1 / 3E5]) * Math.PI / 180, d = A.Math.horner(a, [134.96298, 477198.867398, .0086972, 1 / 5620]) * Math.PI / 180, e = A.Math.horner(a, [93.27191, 483202.017538, -.0036825, 1 / 327270]) * Math.PI / 180, f = A.Math.horner(a, [125.04452, -1934.136261, .0020708, 1 / 45E4]) * Math.PI / 180, g = 0, k = 0, m = A.Nutation.table22A.length - 1; 0 <= m; m--) {
...
A.Solistice = {
  ...
  _eq: function _eq(a, b) {
    for (var c = A.Math.horner(.001 * a, b), d = (c - A.J2000) / A.JulianCentury, e = 35999.373 * Math.PI / 180 * d - 2.47 * Math.PI / 180, e = 1 + .0334 * Math.cos(e) + 7E-4 * Math.cos(2 * e), f = 0, g = this.terms.length - 1; 0 <= g; g--) {
      var k = this.terms[g],
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../libs/MeeusJs-master/meuusjs.1.0.3.min.js"], null)
//# sourceMappingURL=/meuusjs.1.0.3.min.8c3fb1d6.js.map